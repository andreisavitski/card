...
public class RabbitMqListener {
    ...
    public void acceptRequestToReceiveAllCards(String message, @Header("correlationId") String correlationId)
            throws IOException {
...
//    public void acceptMoneyTransferRequest(String message) {
//    }
}
